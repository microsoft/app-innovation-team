            ...
            switch (turnContext.Activity.Type)
            {
                ...
                case ActivityTypes.Message:
                    ...
                    if (text == "/start")
                    {
                        ...
                        await _accessors.DetectedFaceIdPreference.DeleteAsync(turnContext);
                        await _accessors.FullnamePreference.DeleteAsync(turnContext);
                        await _accessors.NamePreference.DeleteAsync(turnContext);
                        await _accessors.LastnamePreference.DeleteAsync(turnContext);
                        await _accessors.IsNewPreference.DeleteAsync(turnContext);
                        await _accessors.ImageUriPreference.DeleteAsync(turnContext);
                        await _accessors.HashPreference.DeleteAsync(turnContext);
