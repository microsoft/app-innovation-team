using BotApp.LUIS.Middleware.Identity.Domain.Enums;
using BotApp.LUIS.Middleware.Identity.Domain.Exceptions;
using BotApp.LUIS.Middleware.Identity.Domain.KeyVault;
using BotApp.LUIS.Middleware.Identity.Domain.Requests;
using BotApp.LUIS.Middleware.Identity.Domain.Responses;
using BotApp.LUIS.Middleware.Identity.Helpers.KeyVault;
...
namespace BotApp.LUIS.Middleware.Identity.Controllers
{
        ...
        public async Task<IActionResult> Post([FromBody]AppAuthenticationRequest model)
        {
            ...
            try
            {
                ...
                var tokeOptions = new JwtSecurityToken(
                    issuer: "https://BotApp.LUIS.Middleware.Identity",
                    audience: "https://BotApp.LUIS.Middleware.Identity",
